(ns marketentry.phase
  "Phase 0->3 staged rollout for the Kingdom of Bhutan (BTN) market-entry
  compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no tender/FDI
  ...
  real e-GP tender response / FDI Registration Certificate application
